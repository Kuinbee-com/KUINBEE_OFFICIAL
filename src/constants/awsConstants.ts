...
export const getDatasetS3Key = (datasetId: string, isPaid: boolean, fileFormat: FileFormatOptions): string =>
    isPaid ? getPaidDatasetS3Key(datasetId, fileFormat) : getFreeDatasetS3Key(datasetId, fileFormat);