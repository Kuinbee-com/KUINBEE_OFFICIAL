...
export const datasetInputValidation = (dataset: IDatasetBaseInput): string | null => {
    const requiredFields: (keyof IDatasetBaseInput)[] = ['title', 'price', 'isPaid', 'license', 'superTypes', 'aboutDatasetInfo', 'sourceId', 'primaryCategoryId', 'security', 'location', 'categories'];
